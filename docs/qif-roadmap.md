...
- The quality-gate verifier has retained negative coverage; v0.4.3 completes
  ...
  v0.6.24 adds `qif review-plan` so humans, independent reviewers, AI agents,
  and eval harnesses can receive a reviewer-ready structural action plan with
...
- Protocol-neutral Action Quality Contract: tool/provider, permission class,
  ...
  v0.6.10 adds handoff policy and evidence for delegated-agent authorization,
  context transfer filtering, delegated authority scope, lifecycle events, and
  governance routing.
